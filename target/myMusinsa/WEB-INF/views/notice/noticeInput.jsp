...
<p><br></p>
	<div class="container">
	  ...
	  <table class="table">
	    ...
	    <tr>
	      <th>공지사항 제목</th>
	      <td><input type="text" name="title" placeholder="공지사항 제목을 입력하세요" class="form-control" autofocus required /></td>
	    </tr>
	    <tr>
	      <th>공지사항 내용</th>
	    ...
	    <tr>
	      <td colspan="2" style="text-align:center">
	        ...
	        <input type="button" value="돌아가기" onclick="location.href='${ctp}/notice/noticeList';" class="btn btn-secondary"/>
	      </td>
	    </tr>
	  </table>
